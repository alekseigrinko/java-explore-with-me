...
(
    ...
    description VARCHAR(5000)                           NOT NULL,
    created     TIMESTAMP WITHOUT TIME ZONE             NOT NULL,
    CONSTRAINT pk_commit_compilations PRIMARY KEY (id),
    CONSTRAINT fk_commit_compilations_on_event FOREIGN KEY (event_id) REFERENCES events (id),
    CONSTRAINT fk_commit_compilations_on_user FOREIGN KEY (author_id) REFERENCES users (id)
);
